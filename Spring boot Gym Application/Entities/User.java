package com.gymwebsite.gym.Entities;
...
public class User {
    ...
    public User(int gId,String firstName,String lastName,String userName, long mobileNo, String passWord,String confirmPassWord, Trainer trainer) {
        this.gId = gId;
        this.firstName = firstName;
        this.lastName = lastName;
        this.userName = userName;
